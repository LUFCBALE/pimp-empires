...
(function(){
  ...
  async function savePimpName(){
    // Pimp names are locked forever at signup - this always rejects
    // server-side, surfacing that via the standard error toast.
    ...
    try{
      ...
      render();
    } catch(e){ /* toast already shown ("Pimp name is locked...") */ }
  }
  ...
  const TUTORIAL_STEPS = [
    {
      ...
      body: "You're building a criminal empire from nothing. This quick tour covers turns, working the block, keeping your crew happy, and how your net worth actually grows.",
    },
    {
      target: '.ts-stat.turns',
      title: '⏳ Turns',
      body: "Turns are your energy. Working the block, attacking, and pulling jobs all cost turns — they refill on their own over time, so you're never stuck for long.",
    },
    {
      target: '.work-panel',
      title: '💼 Work the Block',
      body: "This is your main income. Pick a location, set how many turns to spend, then hit the block — you'll earn cash and pick up new hoes and thugs. Higher-earning spots draw more police attention.",
    },
    {
      target: '#hoeHappinessBlock',
      title: '👠 Hoe Happiness',
      body: "Keep it above 40% (check the Hoes card up top) or hoes start walking. Meds are the fastest fix — buy them right here whenever happiness dips.",
    },
    {
      target: '.ts-stat.thugs',
      title: '💪 Thug Morale',
      body: "Same idea, but guns instead of meds — as many guns as thugs keeps morale at 100%. Happy thugs hit harder in a fight and lower your chance of getting busted.",
    },
    {
      target: '#bribeBtn',
      title: '👮 Bribe the Cops',
      body: "Pay to keep raids off your back for a few minutes — handy right before a big push on the block.",
    },
    {
      target: '#playerMsgBtn',
      title: '✉️ Messages',
      body: "DMs and crew invites both land here — click the envelope any time to check them. A number badge shows up when you've got something unread.",
    },
    {
      target: '.player-networth',
      title: '📈 Building Net Worth',
      body: "Cash and hoes don't count toward net worth, but factories and every thug in your crew do. Buy factories on the Real Estate page for passive production, and keep recruiting muscle — that's what climbs the Leaderboard.",
    },
    {
      target: '[data-page="page-production"]',
      title: '🔧 Production',
      body: "This is where your factories' output actually lives. Sell guns, cars, and cocaine to dealers here, tune your Gun and Car factory mix, and check warehouse storage — anything held over capacity is exposed to a bombing raid, so keep an eye on it.",
    },
    {
      target: '#mobDollarsBtn',
      title: '🪙 Mob Dollars',
      body: "A prize currency you earn from achievements and Hall of Fame wins — never cashable, but spend it right here for an instant turns top-up with no cooldown. Invite friends with your referral link (also in the top bar) to earn even more.",
    },
    {
      target: '[data-page="page-settings"]',
      title: '⚙️ One Last Thing',
      body: 'That\'s the basics! You can turn this welcome tutorial off anytime here in Settings if you don\'t want to see it again.',
    },
  ];
